...
author: "Ege John Isik & Emin Albayram"
output:
  html_document:
    theme: cosmo
    highlight: tango
...
_You can click on the show button to see the relevant code and use the sidebar to navigate to the relevant topic._
...
<div class="main-findings">
<h3>Key Findings from Exploratory Analysis:</h3>
...
<div class="main-findings">
<p>All four performance metrics show a clear positive relationship with salary level, with years of experience and offensive production (especially RBIs) appearing to be the strongest indicators of higher salary.</p>
</div>
...
<div class="main-findings">
<p>Long-term career performance appears to be a more reliable predictor of salary than single-season metrics, suggesting MLB teams value consistency and experience when determining player compensation.</p>
</div>
...
```
<div class="main-findings">
<p>The density plots provide strong evidence that playing time and offensive productivity are both significant factors in determining player salaries, with clear separation between salary tiers.</p>
</div>
...
`r length(selected_vars)` out of `r length(attr(terms(model_full), "term.labels"))` original variables
